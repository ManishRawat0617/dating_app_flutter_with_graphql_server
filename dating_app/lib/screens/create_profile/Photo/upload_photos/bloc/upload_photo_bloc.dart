...
//   void _onAddPhoto(AddPhotoEvent event, Emitter<UploadPhotoState> emit) {
...
//     emit(UploadButtonEnabledChangedState(isEnabled: selectedImages.isNotEmpty));
//   }
