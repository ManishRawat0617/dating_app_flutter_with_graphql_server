...
import 'package:dating_app/screens/create_profile/Photo/verify_user/widget/verify_User_content.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class VerifyUserPage extends StatelessWidget {
  VerifyUserPage({super.key});
  ...
  Widget _buildBody(BuildContext context) {
    return BlocConsumer<PersonalDetailsBloc, PersonalDetailsState>(
      ...
      builder: (context, state) {
        return Scaffold(
          body: VerifyUserContent(), // assuming this uses the bloc
        );
      },
    );
  }
