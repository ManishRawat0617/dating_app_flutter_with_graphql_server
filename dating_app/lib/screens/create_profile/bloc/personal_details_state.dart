...
class AgeRangeUpdatedState extends PersonalDetailsState {
  final RangeValues ageRange;

  const AgeRangeUpdatedState({required this.ageRange});
}

class DistanceUpdateState extends PersonalDetailsState {
  final double distance;

  DistanceUpdateState({required this.distance});
}
