...
import 'package:dating_app/screens/home/widget/person_card.dart';
          ...
          : Padding(
              ...
              child: CardSwiper(
                ...
                cardBuilder:
                  ...
                  bool showLike = percentThresholdX > 0.2;
                  bool showNope = percentThresholdX < -0.2;

                  return PerssonCard(
                      person: person, showLike: showLike, showNope: showNope);
                },
              ),
            ),
    );
